...
export const statusConfig: Record<OrderStatus, { label: string; color: string }> = {
    ...
    [OrderStatus.APPROUVED_BY_SELLER]: { label: "Approuvé", color: "bg-purple-100 text-purple-800" },
...
export const StatusCanBeChanged = {
    [OrderStatus.APPROUVED_BY_SELLER]: { label: "Approuvé", color: "bg-teal-100 text-teal-800" },
    [OrderStatus.DELIVERED]: { label: "Livré", color: "bg-green-100 text-green-800" },
    [OrderStatus.CANCELLED]: { label: "Annulé", color: "bg-red-100 text-red-800" },
};
...
export const filterButtons = [
    ...
    { label: "Approuvé", status: OrderStatus.APPROUVED_BY_SELLER, color: "bg-teal-100 text-teal-800" },
